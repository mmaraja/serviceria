<div class="wrapper  mb-4 mr-4 float-right z-50">
  <div class="fixed bottom-8">
  <button class="btn js-open-popup h-4 w-4" style="background-image: url(<?php echo esc_url( get_theme_file_uri( './assets/at-icon.svg' ) ) ?>)"data-target="custom-popup"></button>
    ...
    <div class="custom-popup__holder js-custom-popup-holder relative container items-center flex justify-center">
      ...
      <div class="custom-popup__content flex justify-center items-center h-full">
        <div class="w-1/2 h-2/3">
          <div id="words" class="float-right text-right text-6xl leading-tight	pr-8 h-full">
